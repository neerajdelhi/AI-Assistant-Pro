...
2. Get a free Gemini API key from [Google AI Studio](https://makersuite.google.com/app/apikeys)
...
- Selected text is sent only to Google's Gemini API for processing
